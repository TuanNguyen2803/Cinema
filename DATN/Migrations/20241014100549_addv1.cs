        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedTiketPrice = table.Column<double>(type: "float", nullable: false),
                    PercentDay = table.Column<int>(type: "int", nullable: false),
                    PercenWeekend = table.Column<int>(type: "int", nullable: false),
                    TimeBeginToChage = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillBillStatus", x => new { x.BillStatusId, x.BillsId });
                    table.ForeignKey(
                        name: "FK_BillBillStatus_billStatuses_BillStatusId",
                        column: x => x.BillStatusId,
                        principalTable: "billStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillBillStatus_bills_BillsId",
                        column: x => x.BillsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillBillStatus_BillsId",
                table: "BillBillStatus",
                column: "BillsId");
